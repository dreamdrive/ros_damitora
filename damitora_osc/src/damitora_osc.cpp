 ...
 // Quaternion: ROS(x,y,z,w) -> Unity(-y,z,x,-w)
  ...
  rotation_w2 = - poseL.orientation.w;
    ...
    p << osc::BeginBundleImmediate
      ...
      << osc::BeginMessage("/VMT/Follow/Unity")
      << (int)1 << (int)1 << (float)0 << position_x1 << position_y1 << position_z1 << rotation_x1 << rotation_y1 << rotation_z1 << rotation_w1 << "HMD" << osc::EndMessage
      << osc::BeginMessage("/VMT/Follow/Unity")
      << (int)2 << (int)1 << (float)0 << position_x2 << position_y2 << position_z2 << rotation_x2 << rotation_y2 << rotation_z2 << rotation_w2 << "HMD" << osc::EndMessage
      << osc::EndBundle;
